...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    after = { "mason-lspconfig.nvim", "trouble.nvim", "clangd_extensions.nvim", "nvim-cmp", "mason.nvim" },
