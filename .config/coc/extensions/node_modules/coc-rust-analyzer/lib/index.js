...
`;
  ...
  await new Promise((resolve, reject) => {
    var _a, _b;
    const handle = (0, import_child_process.execFile)(`nix-build`, ["-E", "-", "--arg", "src", origFile, "-o", dest.toString()], (err, stdout, stderr) => {
      if (err != null) {
        reject(Error(stderr));
      } else {
        resolve(stdout);
...
var Ctx2 = class {
  ...
  async startServer() {
    ...
    client.onNotification(serverStatus, async (status) => {
      var _a;
      this.statusBar.text = `rust-analyzer ${(_a = status.message) != null ? _a : "Ready"}`;
